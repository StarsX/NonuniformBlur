...
namespace XUSG
{
	...
	public:
		...
		void Blit(const CommandList& commandList, uint32_t groupSizeX, uint32_t groupSizeY,
			...
			const DescriptorTable& srvTable = nullptr, uint32_t srvSlot = 0,
			const DescriptorTable& samplerTable = nullptr, uint32_t samplerSlot = 1,
			const Pipeline& pipeline = nullptr);
		uint32_t Blit(const CommandList& commandList, uint32_t groupSizeX, uint32_t groupSizeY,
			uint8_t mipLevel, ResourceState prevMipLevelState, ResourceBarrier* pBarriers,
			const DescriptorTable& uavSrvTable, uint32_t uavSrvSlot = 0, uint32_t numBarriers = 0,
			const DescriptorTable & srvTable = nullptr, uint32_t srvSlot = 0, uint32_t slice = 0);
	...
	public:
		...
		void Blit(const CommandList& commandList, const DescriptorTable& srcSrvTable, uint32_t srcSlot = 0,
			uint8_t mipLevel = 0, uint32_t slice = 0, const DescriptorTable& samplerTable = nullptr,
			uint32_t samplerSlot = 1, const Pipeline& pipeline = nullptr);
		uint32_t Blit(const CommandList& commandList, uint8_t mipLevel, ResourceState prevMipLevelState,
			ResourceBarrier* pBarriers, const DescriptorTable& srcSrvTable, uint32_t srcSlot = 0,
			uint32_t numBarriers = 0, uint32_t slice = 0);
